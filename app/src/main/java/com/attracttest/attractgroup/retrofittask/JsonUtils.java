...
public class JsonUtils {
    private static ArrayList<GitItem> gitItemProfileList;
...
//                    Log.e(LOG_TAG, logDebugString);
                    ...
                    // Create a new {@link GitItem} object
                    gitItemProfileList.add(new GitItem(login, id, avatarUrl, url, followersUrl, gistsUrl,
                            starredUrl, orgUrl, reposUrl, isAdmin));
                }
            }
            Log.e("staty", "size " + gitItemProfileList.size());
            return gitItemProfileList;
